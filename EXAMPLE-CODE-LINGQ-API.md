The following is a working example code from an open-source project. It seems to be using the v3 API, and we might make use of it, using it as a "guide" for what we might need.
...
class LingqApi:
def **init**(self, apiKey: str, languageCode: str):
self.apiKey = apiKey
...
More can be found at https://github.com/thags/lingqAnkiSync/tree/main
